...
import { buildSongContext, type SongContextInput } from './song-context.js';

export type ReferencePromptType = 'character' | 'location';

type ReferenceProjectContext = SongContextInput & {
  title: string;
  visual_style: string;
  aspect_ratio: string;
};
